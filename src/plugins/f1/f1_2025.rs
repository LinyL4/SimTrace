//! Decoder for the official F1 25 UDP layout (specification v3).
...
const CAR_TELEMETRY_PACKET_LEN: usize = 1352;
const CAR_STATUS_PACKET_LEN: usize = 1239;
const LAP_DATA_LEN: usize = 57;
const CAR_TELEMETRY_DATA_LEN: usize = 60;
const CAR_STATUS_DATA_LEN: usize = 55;
...
mod tests {
    ...
    #[test]
    fn decodes_2025_player_values_and_identity() {
        let data = Decoder::default()
            .decode(&test_telemetry_packet(3, 7))
            .unwrap()
            .unwrap();
    ...
    #[test]
    fn validates_2025_version_length_and_car_limit() {
    ...
    #[test]
    fn preserves_2025_assists_and_track_position() {
